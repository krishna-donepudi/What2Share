...
class UserAppsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_app" do
    assert_difference('UserApp.count') do
      post user_apps_url, params: { user_app: { app_id: @user_app.app_id, user_id: @user_app.user_id } }
    end
  ...
  test "should update user_app" do
    patch user_app_url(@user_app), params: { user_app: { app_id: @user_app.app_id, user_id: @user_app.user_id } }
